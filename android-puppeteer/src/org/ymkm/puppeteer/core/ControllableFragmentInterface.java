...
import org.ymkm.puppeteer.FragmentController;
...
public interface ControllableFragmentInterface extends MessageCallback {
     ...
     * 
     * @return true if it has its own thread for the inner Handler, false otherwise
     */
    boolean hasOwnThread();

    /**
     * Returns a name for this fragment that can be used to identify the thread the handler is running within
     * 
     ...
     * <p>
     * A {@link ControllableFragmentInterface} can only communicate with the {@link FragmentController}.
     * </p>
     * The sent message wraps the actual message that will be dispatched by the controller, and has the following values
     * :
     * <dl>
     * <dt>what</dt>
     * <dd>{@link FragmentController#MSG_DISPATCH_MESSAGE} => Dispatches the message in the controller</dd>
     * <dt>arg1</dt>
     * <dd>The control ID assigned to the ControllableFragment that owns this callback</dd>
     * <dt>arg2</dt>
    ...
    /**
     * Sets the arguments for this controllable fragment
     */
    void setArguments(Bundle args);

    /**
     * Returns the arguments set for this controllable fragment
     * 
