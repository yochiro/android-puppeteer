...
public abstract class ControlledActivity extends Activity implements ControllableActivity {
	 ...
	 */
	@Override
	public final List<Class<? extends org.ymkm.puppeteer.core.FragmentControllerCallbackAbstract<FragmentManager,FragmentTransaction>>> getCallbacks(boolean b) {
		List<Class<? extends org.ymkm.puppeteer.core.FragmentControllerCallbackAbstract<FragmentManager,FragmentTransaction>>> list = new
				ArrayList<Class<? extends org.ymkm.puppeteer.core.FragmentControllerCallbackAbstract<FragmentManager,FragmentTransaction>>>();
		List<Class<? extends FragmentControllerCallback>> l = getCallbacks();
		if (null != l && l.size()>0) {
			for (Class<? extends FragmentControllerCallback> c : l) {
				list.add((Class<? extends org.ymkm.puppeteer.core.FragmentControllerCallbackAbstract<FragmentManager,FragmentTransaction>>) c);
			}
		}
		return list;
	}
