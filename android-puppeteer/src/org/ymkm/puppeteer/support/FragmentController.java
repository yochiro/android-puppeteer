...
import org.ymkm.puppeteer.ControlledDialogFragment;
import org.ymkm.puppeteer.ControlledFragment;
import org.ymkm.puppeteer.core.ControllableActivityInterface;
import org.ymkm.puppeteer.core.ControllableFragmentException;
import org.ymkm.puppeteer.core.ControllableFragmentInterface;
import org.ymkm.puppeteer.core.FragmentControllerCallbackAbstract;
import org.ymkm.puppeteer.core.FragmentControllerException;
import org.ymkm.puppeteer.core.FragmentControllerInterface;
...
public final class FragmentController implements FragmentControllerInterface<FragmentManager, FragmentTransaction> {
    ...
    public FragmentController register(ControllableActivityInterface<FragmentManager, FragmentTransaction> controllable) {
        ...
        if (!mFragments.containsKey(controllable.getControllableName())) {
            mFragments.put(controllable.getControllableName(),
                    new SparseArray<WeakReference<ControllableFragmentInterface>>());
        }
        else {
     ...
     */
    @Override
    public FragmentController unregister(
            ControllableActivityInterface<FragmentManager, FragmentTransaction> controllable) {
    ...
    @Override
    public FragmentController add(
            final ControllableActivityInterface<FragmentManager, FragmentTransaction> controllable,
    ...
    public FragmentController add(
        ...
        ControllableFragmentInterface frag = newControllableFragment(fragmentClass, false);
        assert (null != frag);
    ...
    public FragmentController add(
            ...
            throws ControllableFragmentException, FragmentControllerException {
        ControllableFragmentInterface frag = newControllableFragment(fragmentClass, runsInNewThread);
        assert (null != frag);
        return add(controllable, ft, controlId, containerViewId, frag);
    }
    ...
    public FragmentController add(
            final ControllableActivityInterface<FragmentManager, FragmentTransaction> controllable,
            FragmentTransaction ft, int controlId, int containerViewId,
            Class<? extends ControllableFragmentInterface> fragmentClass, Bundle args)
            throws ControllableFragmentException, FragmentControllerException {
        assert (null != args);
        ControllableFragmentInterface frag = newControllableFragment(fragmentClass, false);
        assert (null != frag);
        return add(controllable, ft, controlId, containerViewId, frag, args);
    }
    ...
    public FragmentController add(
            final ControllableActivityInterface<FragmentManager, FragmentTransaction> controllable,
            FragmentTransaction ft, int controlId, ControllableFragmentInterface fragment)
            throws ControllableFragmentException, FragmentControllerException {
        Bundle b = (null != fragment.getArguments() ? fragment.getArguments() : new Bundle());
        return add(controllable, ft, controlId, 0, fragment, b);
    }
    ...
    public FragmentController add(
            ...
            throws ControllableFragmentException, FragmentControllerException {
        Bundle b = (null != fragment.getArguments() ? fragment.getArguments() : new Bundle());
        return add(controllable, ft, controlId, containerViewId, fragment, b);
    }
    ...
    public FragmentController show(
        ...
        ControllableFragmentInterface fragment = mFragments.get(controllable.getControllableName())
                .get(controlId, null).get();
    ...
    @Override
    public FragmentController hide(
            final ControllableActivityInterface<FragmentManager, FragmentTransaction> controllable,
            FragmentTransaction ft, int controlId) throws FragmentControllerException {
    ...
    public FragmentController replace(
        ...
        ControllableFragmentInterface frag = newControllableFragment(fragmentClass, false);
        assert (null != frag);
        return replace(controllable, ft, controlId, containerViewId, frag, args);
    }
    ...
    public FragmentController replace(ControllableActivityInterface<FragmentManager, FragmentTransaction> controllable,
            FragmentTransaction ft, int controlId, int containerViewId, ControllableFragmentInterface fragment) {
        Bundle b = (null != fragment.getArguments() ? fragment.getArguments() : new Bundle());
        return replace(controllable, ft, controlId, containerViewId, fragment, b);
    }
    ...
    @Override
    public FragmentController remove(
            final ControllableActivityInterface<FragmentManager, FragmentTransaction> controllable,
            FragmentTransaction ft, int controlId) throws FragmentControllerException {
    ...
    @Override
    public FragmentController addCallback(
            ControllableActivityInterface<FragmentManager, FragmentTransaction> controllable,
    ...
    private FragmentControllerCallbackAbstract<FragmentManager, FragmentTransaction> newFragmentControllerCallback(
            ControllableActivityInterface<?, ?> controllable,
            Class<? extends FragmentControllerCallbackAbstract<?, ?>> cls) {
     ...
     * 
     * The instantiation is delegated to the class implementing {@link ControllableFragmentInterface} passed as a
     * parameter.
     * <p>
     * It looks up for a static {@code createFragment(Class<? extends ControllableFragment>, boolean, Bundle)} method
     * should be defined in the class implementing {@link ControllableFragmentInterface} that is passed as the first
     ...
     */
    private ControllableFragmentInterface newControllableFragment(
            Class<? extends ControllableFragmentInterface> fragmentClass, boolean runsInNewThread) {
        ...
        for (Method m : allMs) {
            ...
            if (types.length == 2 && types[0].equals(Class.class) && types[1].equals(boolean.class)) {
                try {
                    fragment = (ControllableFragmentInterface) m.invoke(fragmentClass, fragmentClass, runsInNewThread);
                    return fragment;
                }
                catch (IllegalArgumentException e) {
                    e.printStackTrace();
