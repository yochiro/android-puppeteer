...
package org.ymkm.puppeteer.core;

import org.ymkm.puppeteer.FragmentControllerApplication;
...
public interface FragmentControllerInterface<FM, FT> extends MessageCallback, RunnableQueue {
    ...
    FragmentControllerInterface<FM, FT> add(final ControllableActivityInterface<FM, FT> controllable, FT ft,
            int controlId, Class<? extends ControllableFragmentInterface> fragmentClass)
            throws ControllableFragmentException, FragmentControllerException;

    FragmentControllerInterface<FM, FT> add(final ControllableActivityInterface<FM, FT> controllable, FT ft,
            int controlId, Class<? extends ControllableFragmentInterface> fragmentClass, boolean runsInNewThread)
            throws ControllableFragmentException, FragmentControllerException;

    FragmentControllerInterface<FM, FT> add(final ControllableActivityInterface<FM, FT> controllable, FT ft,
            int controlId, int containerViewId, Class<? extends ControllableFragmentInterface> fragmentClass)
            throws ControllableFragmentException, FragmentControllerException;
    ...
    FragmentControllerInterface<FM, FT> add(final ControllableActivityInterface<FM, FT> controllable, FT ft,
            int controlId, Class<? extends ControllableFragmentInterface> fragmentClass, Bundle args)
            throws ControllableFragmentException, FragmentControllerException;
    ...
    FragmentControllerInterface<FM, FT> add(final ControllableActivityInterface<FM, FT> controllable, FT ft,
            int controlId, ControllableFragmentInterface fragment) throws ControllableFragmentException,
            FragmentControllerException;

    FragmentControllerInterface<FM, FT> add(final ControllableActivityInterface<FM, FT> controllable, FT ft,
            int controlId, int containerViewId, ControllableFragmentInterface fragment)
            throws ControllableFragmentException, FragmentControllerException;

    FragmentControllerInterface<FM, FT> add(final ControllableActivityInterface<FM, FT> controllable, FT ft,
            int controlId, int containerViewId, ControllableFragmentInterface fragment, Bundle args)
            throws ControllableFragmentException, FragmentControllerException;

    FragmentControllerInterface<FM, FT> addToBackStack(FT ft, String name) throws FragmentControllerException;

    FragmentControllerInterface<FM, FT> show(final ControllableActivityInterface<FM, FT> controllable, FT ft,
            int controlId) throws FragmentControllerException;

    FragmentControllerInterface<FM, FT> hide(final ControllableActivityInterface<FM, FT> controllable, FT ft,
            int controlId) throws FragmentControllerException;
    ...
    FragmentControllerInterface<FM, FT> replace(final ControllableActivityInterface<FM, FT> controllable, FT ft,
            int controlId, int containerViewId, Class<? extends ControllableFragmentInterface> fragmentClass)
            throws ControllableFragmentException, FragmentControllerException;
    ...
    FragmentControllerInterface<FM, FT> remove(final ControllableActivityInterface<FM, FT> controllable, FT ft,
            int controlId) throws FragmentControllerException;
