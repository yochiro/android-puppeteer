 ...
 * sent to the controller using {@linkplain FragmentControllerInterface#MSG_DISPATCH_MESSAGE} as the message.
 * </p>
 */
public interface ControllableFragmentCallbackInterface extends Callback {
	 ...
	 * <p>
	 * A {@link ControllableFragmentInterface} can only communicate with the {@link FragmentControllerInterface}.
	 * </p>
	 * The sent message wraps the actual message that will be dispatched by the controller,
	 * and has the following values :
	 * <dl>
	 * <dt>what</dt><dd>{@link FragmentControllerInterface#MSG_DISPATCH_MESSAGE} => Dispatches the message in the controller</dd>
